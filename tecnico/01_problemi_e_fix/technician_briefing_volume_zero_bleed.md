...
- `../foto/IMG_5543.jpg`: foto locale della board `PC2400-3 REV B`, area alimentazione, tre TO-220 su dissipatore/case, connettori e condensatori vicini.
- `../05_pagine_rilevanti/note/pvs_service/page_004.md` ([nota](../05_pagine_rilevanti/note/pvs_service/page_004.md)) e `../05_pagine_rilevanti/immagini/pvs_service/page_004.png` ([immagine](../05_pagine_rilevanti/immagini/pvs_service/page_004.png)): keyboard/power supply, pressure circuit, `U301/U302/U303`, `U304`, `U305`, `U310`, rail `+5VD`, `+12V`, `-12V`, `AGND`, `DGND`.
- `../05_pagine_rilevanti/note/pvs_service/page_005.md` ([nota](../05_pagine_rilevanti/note/pvs_service/page_005.md)) e `../05_pagine_rilevanti/immagini/pvs_service/page_005.png` ([immagine](../05_pagine_rilevanti/immagini/pvs_service/page_005.png)): layout/artwork fisico della board, utile per localizzare i riferimenti e confrontarli con la foto.
- `../05_pagine_rilevanti/note/sci_prophet_vs_ecr739/page_004.md` ([nota](../05_pagine_rilevanti/note/sci_prophet_vs_ecr739/page_004.md)) e `../05_pagine_rilevanti/immagini/sci_prophet_vs_ecr739/page_004.png` ([immagine](../05_pagine_rilevanti/immagini/sci_prophet_vs_ecr739/page_004.png)): ECR739, pressure circuit e power supply; conferma `U301 7805`, `U302 7812`, `U303 7912`, `U304 78L05`, `U305 HC132`, `U310`, `TP301/TP302`.
- `../03_mappe_circuito/power_reset.md` ([mappa](../03_mappe_circuito/power_reset.md)): mappa rail/reset e failure mode associati a rail bassi, ripple e ground.
- `../04_componenti_net_rail/ics.md` ([indice](../04_componenti_net_rail/ics.md)): indice IC/regolatori, inclusi `U301/U302/U303`, CEM5530 `U449/U425`, `U459`, `U310`, `U401/U402/U450`.
- `../04_componenti_net_rail/power_rails.md` ([indice](../04_componenti_net_rail/power_rails.md)): indice rail `+5VD`, `+12V`, `-12V`, `+8V`, `+5.6V`, `-5V`, `AGND/DGND`.
- `../03_mappe_circuito/audio_path.md` ([mappa](../03_mappe_circuito/audio_path.md)): percorso VCF/VCA/PAN/output e possibili cause di bleed.
- `../03_mappe_circuito/sample_hold_cv.md` ([mappa](../03_mappe_circuito/sample_hold_cv.md)): CEM5530, DAC, timing `INH`, uscite CV `VCA/VCF/PAN/LEV`.
- `../03_mappe_circuito/pressure_aftertouch.md` ([mappa](../03_mappe_circuito/pressure_aftertouch.md)): `PRESSURE/SENSOR`, `U310`, `U459`, reti ECR.
- `../03_mappe_circuito/board_revisions_ecr.md` ([mappa](../03_mappe_circuito/board_revisions_ecr.md)): confronto ECR738/ECR739 e checklist di modifica fisica.
...
Componenti/net/pagine: `U301/U302/U303`, `+5VD`, `+12V`, `-12V`, `C301/C304/C305/C307/C308/C309`, `pvs_service` pagine 4/5, `sci_prophet_vs_ecr739` pagina 4, `../foto/IMG_5543.jpg`.
...
- Identificazione visiva dei tre regolatori su `../foto/IMG_5543.jpg`: `U301 7805`, `U302 7812`, `U303 7912`; la designator map indica sinistra->destra `U301/U302/U303`, da confermare sulla PCB reale se la serigrafia e' visibile.
