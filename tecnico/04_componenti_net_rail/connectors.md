...
| 3 porte MIDI DIN | `MIDI IN`, `MIDI OUT`, `MIDI OUT/THRU` | Corrosione o contatti laschi possono bloccare MIDI; la nuova foto mostra una DIN diversa dai Jalco PCB moderni linkati inizialmente. Prima pista ricambio: famiglia Switchcraft `57NC5FX` / `57GB5FX` / `57PC5F`, da misurare | pvs_service pagina 3; foto `../foto/midi_din_originale_01.JPG`; vedi `../01_problemi_e_fix/pannello_posteriore_ricambi.md` |
