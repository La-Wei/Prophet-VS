...
| SRAM patch + batteria | Memoria programmi | Le SRAM originali restano alimentate dalla batteria a synth spento; `ELD5530` non cambia questa parte; vedi `../01_problemi_e_fix/batteria_memoria_nvram.md` | pvs_service CPU/memoria, Synthelectro 2015 |
