# sci_prophet_vs_ecr738 pagina 3

Source: `doc/sci_prophet_vs_ecr738.pdf` pagina 3  
Immagine: [sci_prophet_vs_ecr738/page_003.png](../../page_images/sci_prophet_vs_ecr738/page_003.png)  
Testo/OCR: [sci_prophet_vs_ecr738/page_003.txt](../../extracted_text/sci_prophet_vs_ecr738/page_003.txt)  
Metodo testo: `ocr`, confidenza: `low`

## Cosa sembra contenere questa pagina
ECR 738, dettaglio board/artwork poco leggibile. Tipo pagina: board artwork / layout, ECR / engineering change record.
...
- OCR molto scarso; si legge solo parzialmente OSCIL/BOARD e testo non affidabile.

Inferenza ragionevole:
- Probabile immagine di riferimento fisico/artwork collegata alla modifica ECR 738.
...
## Cross-reference
- [sci_prophet_vs_ecr738 pagina 2](page_002.md)
