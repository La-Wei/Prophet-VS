# sci_prophet_vs_ecr739 pagina 3

Source: `doc/sci_prophet_vs_ecr739.pdf` pagina 3  
Immagine: [sci_prophet_vs_ecr739/page_003.png](../../page_images/sci_prophet_vs_ecr739/page_003.png)  
Testo/OCR: [sci_prophet_vs_ecr739/page_003.txt](../../extracted_text/sci_prophet_vs_ecr739/page_003.txt)  
Metodo testo: `ocr`, confidenza: `unavailable`

## Cosa sembra contenere questa pagina
ECR 739, pagina quasi illeggibile. Tipo pagina: ECR / engineering change record, board revision.
...
- OCR quasi nullo; non usare questa pagina senza ispezione immagine manuale.

Inferenza ragionevole:
- Possibile pagina intermedia o allegato della modifica ECR 739.
...
## Cross-reference
- [sci_prophet_vs_ecr739 pagina 4](page_004.md)
